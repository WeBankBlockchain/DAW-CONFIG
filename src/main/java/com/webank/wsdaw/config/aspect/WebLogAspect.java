package com.webank.wsdaw.config.aspect;

import cn.hutool.json.JSONUtil;
import com.webank.wsdaw.config.enums.CodeEnum;
import com.webank.wsdaw.config.monitor.MonitorEntry;
import com.webank.wsdaw.config.monitor.MonitorUtil;
...
public class WebLogAspect {
    ...
    @Around("execution(* com.webank.wsdaw.config.controller.*.*(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* com.webank.wsdaw.config.controller.*.*(..))",
            returning = "result")
